/** This file was autogenerated by the mpc_planner_solver package at 08:37PM on September 02, 2025*/
...
void setSolverParameterSlack(int k, AcadosParameters& params, const double value, int index=0);
